...
def draw_text(screen, total_time_taken, wall_mode):
    ...
    toggle_surface = font_small.render("Press T to Toggle Wall Mode", True, BLACK)
    author1 = font_small.render("Anush Bundel 2023BCS0005", True, BLACK)
    author2 = font_small.render("Ankush 2023BCS0131", True, BLACK)
    ...
    screen.blit(wall_surface, (WIDTH - 650, HEIGHT + 5))
    screen.blit(toggle_surface, (WIDTH - 650, HEIGHT + 30))
    screen.blit(author1, (WIDTH - 380, HEIGHT + 5))
    screen.blit(author2, (WIDTH - 380, HEIGHT + 30))
    screen.blit(run_info, (WIDTH - 900, HEIGHT + 5))
    screen.blit(reset_info, (WIDTH - 900, HEIGHT + 30))
    screen.blit(agent_info, (WIDTH - 1150, HEIGHT + 5))
    screen.blit(goal_info, (WIDTH - 1150, HEIGHT + 30))
